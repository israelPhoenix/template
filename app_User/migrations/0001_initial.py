    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('non_defini', 'Non défini'), ('ADMIN', 'Admin'), ('DOYEN', 'Doyen'), ('TEACHER', 'Teacher'), ('STUDENT', 'Student')], default='non_defini', max_length=25, verbose_name='Role')),
                ('profile_photo', models.ImageField(blank=True, null=True, upload_to='profile_photos')),
                ('nationalite', models.CharField(blank=True, max_length=255, null=True)),
                ('gender', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female')], max_length=65, null=True)),
